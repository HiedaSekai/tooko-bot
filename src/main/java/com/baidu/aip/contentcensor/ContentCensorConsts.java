...
public class ContentCensorConsts {
    ...
    static final String USER_DEFINED_IMAGE_URL = "https://aip.baidubce.com/rest/2" + ".0/solution/v1/img_censor/v2/user_defined";
    static final String USER_DEFINED_TEXT_URL = "https://aip.baidubce.com/rest/2" + ".0/solution/v1/text_censor/v2/user_defined";
