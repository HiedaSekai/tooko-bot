...
class TdApi {
    ...
    class TdlibParameters(
        ...
        var useChatInfoDatabase: Boolean = false,
        ...
        var enableStorageOptimizer: Boolean = false,
    ...
    class AuthenticationCodeInfo(
        ...
        var type: AuthenticationCodeType,
        var nextType: AuthenticationCodeType?,
        var timeout: Int
    ) : Object() {
    ...
    class FormattedText(
        var text: String,
        var entities: Array<TextEntity> = emptyArray()
    ) : Object() {
    ...
    class AuthorizationStateWaitPassword(
        ...
        var hasRecoveryEmailAddress: Boolean,
        var recoveryEmailAddressPattern: String
    ) : AuthorizationState() {
    ...
    class PasswordState(
        ...
        var passwordHint: String?,
        var hasRecoveryEmailAddress: Boolean,
        var hasPassportData: Boolean,
        var recoveryEmailAddressCodeInfo: EmailAddressAuthenticationCodeInfo?
    ) : Object() {
    ...
    class LocalFile(
        var path: String?,
        var canBeDownloaded: Boolean,
        var canBeDeleted: Boolean,
        var isDownloadingActive: Boolean,
        var isDownloadingCompleted: Boolean,
        var downloadOffset: Int,
        var downloadedPrefixSize: Int,
    ...
    class Audio(
        ...
        var fileName: String,
        var mimeType: String,
        var albumCoverMinithumbnail: Minithumbnail?,
        var albumCoverThumbnail: PhotoSize?,
        var audio: File
    ) : Object() {
    ...
    class UserTypeBot(
        ...
        var canReadAllGroupMessages: Boolean,
        var isInline: Boolean,
        var inlineQueryPlaceholder: String,
    ...
    class User(
        ...
        var isMutualContact: Boolean,
        var isVerified: Boolean,
        var isSupport: Boolean,
        var restrictionReason: String,
        var isScam: Boolean,
        var haveAccess: Boolean,
        var type: UserType,
    ...
    class UserFullInfo(
        ...
        var canBeCalled: Boolean,
        var hasPrivateCalls: Boolean,
        var needPhoneNumberPrivacyException: Boolean,
        var bio: String,
        var shareText: String,
        var groupInCommonCount: Int,
        var botInfo: BotInfo?
    ) : Object() {
    ...
    class UserProfilePhotos(
        var totalCount: Int,
        var photos: Array<UserProfilePhoto>
    ) : Object() {
    ...
    class ChatAdministrators(
        var administrators: Array<ChatAdministrator>
    ) : Object() {
    ...
    class ChatPermissions(
        ...
        var canSendMediaMessages: Boolean = false,
    ...
    class BasicGroup(
        ...
        var upgradedToSupergroupId: Int
    ) : Object() {
    ...
    class Supergroup(
        ...
        var status: ChatMemberStatus,
        var memberCount: Int,
        var hasLinkedChat: Boolean,
        var hasLocation: Boolean,
        var signMessages: Boolean,
        var isSlowModeEnabled: Boolean,
    ...
    class SupergroupFullInfo(
        ...
        var bannedCount: Int,
        var linkedChatId: Long,
        var slowModeDelay: Int,
        var slowModeDelayExpiresIn: Double,
        var canGetMembers: Boolean,
        var canSetUsername: Boolean,
        var canSetStickerSet: Boolean,
        var canSetLocation: Boolean,
        var canViewStatistics: Boolean,
        var isAllHistoryAvailable: Boolean,
        var stickerSetId: Long,
        var location: ChatLocation?,
        var inviteLink: String,
        var upgradedFromBasicGroupId: Int,
        var upgradedFromMaxMessageId: Long
    ) : Object() {
    ...
    class MessageForwardInfo(
        var origin: MessageForwardOrigin,
        var date: Int,
        var fromChatId: Long,
    ...
    class Message(
        ...
        var canBeDeletedOnlyForSelf: Boolean,
        var canBeDeletedForAllUsers: Boolean,
        var isChannelPost: Boolean,
        var containsUnreadMention: Boolean,
        var date: Int,
        var editDate: Int,
        var forwardInfo: MessageForwardInfo?,
        var replyToMessageId: Long,
        var ttl: Int,
        var ttlExpiresIn: Double,
        var viaBotUserId: Int,
        var authorSignature: String,
        var views: Int,
        var mediaAlbumId: Long,
        var restrictionReason: String,
    ...
    class ChatNotificationSettings(
        var useDefaultMuteFor: Boolean = false,
        var muteFor: Int = 0,
        var useDefaultSound: Boolean = false,
        var sound: String,
        var useDefaultShowPreview: Boolean = false,
        var showPreview: Boolean = false,
        var useDefaultDisablePinnedMessageNotifications: Boolean = false,
        var disablePinnedMessageNotifications: Boolean = false,
        var useDefaultDisableMentionNotifications: Boolean = false,
        var disableMentionNotifications: Boolean = false
    ) : Object() {
     ...
     */
    class DraftMessage(
        var replyToMessageId: Long = 0L,
        var inputMessageText: InputMessageContent
    ) : Object() {
    ...
    class Chat(
        ...
        var isMarkedAsUnread: Boolean,
        var isSponsored: Boolean,
        var hasScheduledMessages: Boolean,
        var canBeDeletedOnlyForSelf: Boolean,
        var canBeDeletedForAllUsers: Boolean,
        var canBeReported: Boolean,
        var defaultDisableNotification: Boolean,
        var unreadCount: Int,
        ...
        var actionBar: ChatActionBar?,
        var pinnedMessageId: Long,
        var replyMarkupMessageId: Long,
     ...
     */
    class ChatsNearby(
        var usersNearby: Array<ChatNearby>,
        var supergroupsNearby: Array<ChatNearby>
    ) : Object() {
    ...
    class InlineKeyboardButton(
        var text: String,
        var type: InlineKeyboardButtonType
    ) : Object() {
    ...
    class ReplyMarkupShowKeyboard(
        var rows: Array<Array<KeyboardButton>> = emptyArray(),
    ...
    class ReplyMarkupInlineKeyboard(
        var rows: Array<Array<InlineKeyboardButton>> = emptyArray()
    ) : ReplyMarkup() {
    ...
    class LoginUrlInfoRequestConfirmation(
        ...
        var domain: String,
        var botUserId: Int,
        var requestWriteAccess: Boolean
    ) : LoginUrlInfo() {
    ...
    class PageBlockListItem(
        var label: String,
        var pageBlocks: Array<PageBlock>
    ) : Object() {
    ...
    class PageBlockTableCell(
        ...
        var colspan: Int,
        var rowspan: Int,
        var align: PageBlockHorizontalAlignment,
        var valign: PageBlockVerticalAlignment
    ) : Object() {
     ...
     */
    class PageBlockList(
        var items: Array<PageBlockListItem>
    ) : PageBlock() {
    ...
    class PageBlockTable(
        ...
        var cells: Array<Array<PageBlockTableCell>>,
        var isBordered: Boolean,
    ...
    class PageBlockRelatedArticles(
        var header: RichText,
        var articles: Array<PageBlockRelatedArticle>
    ) : PageBlock() {
    ...
    class Invoice(
        var currency: String,
        var priceParts: Array<LabeledPricePart> = emptyArray(),
        var isTest: Boolean = false,
        var needName: Boolean = false,
        var needPhoneNumber: Boolean = false,
        var needEmailAddress: Boolean = false,
        var needShippingAddress: Boolean = false,
        var sendPhoneNumberToProvider: Boolean = false,
        var sendEmailAddressToProvider: Boolean = false,
    ...
    class PaymentsProviderStripe(
        ...
        var needCountry: Boolean,
        var needPostalCode: Boolean,
        var needCardholderName: Boolean
    ) : Object() {
    ...
    class PaymentForm(
        var invoice: Invoice,
        var url: String,
        var paymentsProvider: PaymentsProviderStripe?,
        var savedOrderInfo: OrderInfo?,
        var savedCredentials: SavedCredentials?,
        var canSaveCredentials: Boolean,
    ...
    class ValidatedOrderInfo(
        var orderInfoId: String,
        var shippingOptions: Array<ShippingOption>
    ) : Object() {
    ...
    class PaymentReceipt(
        var date: Int,
        var paymentsProviderUserId: Int,
        var invoice: Invoice,
    ...
    class IdentityDocument(
        var number: String,
        var expiryDate: Date?,
        var frontSide: DatedFile,
        var reverseSide: DatedFile,
        var selfie: DatedFile?,
        var translation: Array<DatedFile>
    ) : Object() {
    ...
    class InputIdentityDocument(
        ...
        var translation: Array<InputFile> = emptyArray()
    ) : Object() {
    ...
    class InputPersonalDocument(
        var files: Array<InputFile> = emptyArray(),
        var translation: Array<InputFile> = emptyArray()
    ) : Object() {
    ...
    class PassportElementDriverLicense(
        var driverLicense: IdentityDocument
    ) : PassportElement() {
    ...
    class PassportElementIdentityCard(
        var identityCard: IdentityDocument
    ) : PassportElement() {
    ...
    class PassportElementInternalPassport(
        var internalPassport: IdentityDocument
    ) : PassportElement() {
    ...
    class PassportElementUtilityBill(
        var utilityBill: PersonalDocument
    ) : PassportElement() {
    ...
    class PassportElementBankStatement(
        var bankStatement: PersonalDocument
    ) : PassportElement() {
    ...
    class PassportElementRentalAgreement(
        var rentalAgreement: PersonalDocument
    ) : PassportElement() {
    ...
    class PassportElementPassportRegistration(
        var passportRegistration: PersonalDocument
    ) : PassportElement() {
    ...
    class PassportElementTemporaryRegistration(
        var temporaryRegistration: PersonalDocument
    ) : PassportElement() {
    ...
    class PassportElements(
        var elements: Array<PassportElement>
    ) : Object() {
    ...
    class PassportElementError(
        var type: PassportElementType,
        var message: String,
        var source: PassportElementErrorSource
    ) : Object() {
    ...
    class PassportSuitableElement(
        var type: PassportElementType,
        var isSelfieRequired: Boolean,
        var isTranslationRequired: Boolean,
        var isNativeNameRequired: Boolean
    ) : Object() {
    ...
    class PassportRequiredElement(
        var suitableElements: Array<PassportSuitableElement>
    ) : Object() {
    ...
    class PassportAuthorizationForm(
        var id: Int,
        var requiredElements: Array<PassportRequiredElement>,
    ...
    class InputPassportElementErrorSourceUnspecified(
        var elementHash: ByteArray = byteArrayOf()
    ...
    class InputPassportElementErrorSourceDataField(
        ...
        var dataHash: ByteArray = byteArrayOf()
    ) : InputPassportElementErrorSource() {
    ...
    class InputPassportElementErrorSourceTranslationFiles(
        var fileHashes: Array<ByteArray> = emptyArray()
    ) : InputPassportElementErrorSource() {
    ...
    class MessageInvoice(
        ...
        var isTest: Boolean,
        var needShippingAddress: Boolean,
        var receiptMessageId: Long
    ) : MessageContent() {
     ...
     */
    class MessageCall(
        var discardReason: CallDiscardReason,
        var duration: Int
    ) : MessageContent() {
    ...
    class MessagePassportDataSent(
        var types: Array<PassportElementType>
    ) : MessageContent() {
    ...
    class MessagePassportDataReceived(
        var elements: Array<EncryptedPassportElement>,
    ...
    class SendMessageOptions(
        ...
        var fromBackground: Boolean = false,
    ...
    class InputMessagePhoto(
        ...
        var thumbnail: InputThumbnail? = null,
        var addedStickerFileIds: IntArray = intArrayOf(),
        var width: Int = 0,
        var height: Int = 0,
        var caption: FormattedText? = null,
        var ttl: Int = 0
    ...
    class InputMessageVoiceNote(
        ...
        var duration: Int = 0,
        var waveform: ByteArray = byteArrayOf(),
        var caption: FormattedText? = null
    ) : InputMessageContent() {
    ...
    class InputMessageForwarded(
        var fromChatId: Long = 0L,
        var messageId: Long = 0L,
        var inGameShare: Boolean = false,
        var sendCopy: Boolean = false,
        var removeCaption: Boolean = false
    ) : InputMessageContent() {
    ...
    class CallStateReady(
        var protocol: CallProtocol,
        var connections: Array<CallConnection>,
        var config: String,
        var encryptionKey: ByteArray,
        var emojis: Array<String>,
        var allowP2p: Boolean
    ) : CallState() {
    ...
    class CallStateDiscarded(
        var reason: CallDiscardReason,
        var needRating: Boolean,
        var needDebugInformation: Boolean
    ) : CallState() {
    ...
    class InputInlineQueryResultAnimatedMpeg4(
        ...
        var mpeg4Duration: Int = 0,
        var mpeg4Width: Int = 0,
        var mpeg4Height: Int = 0,
        var replyMarkup: ReplyMarkup? = null,
        var inputMessageContent: InputMessageContent? = null
    ) : InputInlineQueryResult() {
    ...
    class InputInlineQueryResultSticker(
        ...
        var stickerWidth: Int = 0,
        var stickerHeight: Int = 0,
        var replyMarkup: ReplyMarkup? = null,
        var inputMessageContent: InputMessageContent? = null
    ) : InputInlineQueryResult() {
    ...
    class GameHighScores(
        var scores: Array<GameHighScore>
    ) : Object() {
    ...
    class ChatEventMemberPromoted(
        var userId: Int,
        var oldStatus: ChatMemberStatus,
        var newStatus: ChatMemberStatus
    ) : ChatEventAction() {
    ...
    class ChatEventPermissionsChanged(
        var oldPermissions: ChatPermissions,
        var newPermissions: ChatPermissions
    ) : ChatEventAction() {
    ...
    class ChatEventLinkedChatChanged(
        var oldLinkedChatId: Long,
        var newLinkedChatId: Long
    ) : ChatEventAction() {
    ...
    class ChatEventSlowModeDelayChanged(
        var oldSlowModeDelay: Int,
        var newSlowModeDelay: Int
    ) : ChatEventAction() {
    ...
    class ChatEventStickerSetChanged(
        var oldStickerSetId: Long,
        var newStickerSetId: Long
    ) : ChatEventAction() {
    ...
    class ChatEventLocationChanged(
        var oldLocation: ChatLocation?,
        var newLocation: ChatLocation?
    ) : ChatEventAction() {
    ...
    class ChatEventLogFilters(
        var messageEdits: Boolean = false,
        var messageDeletions: Boolean = false,
        var messagePins: Boolean = false,
        var memberJoins: Boolean = false,
        var memberLeaves: Boolean = false,
        var memberInvites: Boolean = false,
        var memberPromotions: Boolean = false,
        var memberRestrictions: Boolean = false,
        var infoChanges: Boolean = false,
        var settingChanges: Boolean = false
    ) : Object() {
    ...
    class LanguagePackString(
        var key: String,
        var value: LanguagePackStringValue
    ) : Object() {
    ...
    class LanguagePackStrings(
        var strings: Array<LanguagePackString>
    ) : Object() {
    ...
    class LanguagePackInfo(
        ...
        var translatedStringCount: Int = 0,
    ...
    class LocalizationTargetInfo(
        var languagePacks: Array<LanguagePackInfo>
    ) : Object() {
    ...
    class DeviceTokenApplePush(
        ...
        var isAppSandbox: Boolean = false
    ) : DeviceToken() {
    ...
    class BackgroundFillSolid(
        ...
        override val constructor: Int get() = 1010678813
    }
    ...
    class BackgroundFillGradient(
        ...
        override val constructor: Int get() = -1839206017
    }
    ...
    class BackgroundTypePattern(
        ...
        override val constructor: Int get() = 649993914
    }
    ...
    class BackgroundTypeFill(
        ...
        override val constructor: Int get() = 993008684
    }
    ...
    class NotificationTypeNewPushMessage(
        var messageId: Long,
        var senderUserId: Int,
        var content: PushMessageContent
    ) : NotificationType() {
    ...
    class NotificationGroup(
        var id: Int,
        var type: NotificationGroupType,
        var chatId: Long,
        var totalCount: Int,
    ...
    class JsonValueArray(
        var values: Array<JsonValue> = emptyArray()
    ) : JsonValue() {
    ...
    class JsonValueObject(
        var members: Array<JsonObjectMember> = emptyArray()
    ) : JsonValue() {
    ...
    class UserPrivacySettingRuleAllowChatMembers(
        var chatIds: LongArray = longArrayOf()
    ) : UserPrivacySettingRule() {
    ...
    class UserPrivacySettingRules(
        var rules: Array<UserPrivacySettingRule> = emptyArray()
    ) : Object() {
    ...
    class Session(
        ...
        var isPasswordPending: Boolean,
        var apiId: Int,
        var applicationName: String,
        var applicationVersion: String,
        var isOfficialApplication: Boolean,
        var deviceModel: String,
        var platform: String,
        var systemVersion: String,
        var logInDate: Int,
    ...
    class ConnectedWebsites(
        var websites: Array<ConnectedWebsite>
    ) : Object() {
    ...
    class StorageStatisticsByChat(
        ...
        var size: Long,
        var count: Int,
        var byFileType: Array<StorageStatisticsByFileType>
    ) : Object() {
    ...
    class StorageStatistics(
        var size: Long,
        var count: Int,
        var byChat: Array<StorageStatisticsByChat>
    ) : Object() {
    ...
    class StorageStatisticsFast(
        var filesSize: Long,
        var fileCount: Int,
        var databaseSize: Long,
        var languagePackDatabaseSize: Long,
        var logSize: Long
    ) : Object() {
    ...
    class NetworkStatistics(
        var sinceDate: Int,
        var entries: Array<NetworkStatisticsEntry>
    ) : Object() {
    ...
    class AutoDownloadSettings(
        var isAutoDownloadEnabled: Boolean = false,
        var maxPhotoFileSize: Int = 0,
        var maxVideoFileSize: Int = 0,
        var maxOtherFileSize: Int = 0,
        var videoUploadBitrate: Int = 0,
        var preloadLargeVideos: Boolean = false,
        var preloadNextAudio: Boolean = false,
        var useLessDataForCalls: Boolean = false
    ) : Object() {
        override val constructor: Int get() = -2144418333
    }
    ...
    class AutoDownloadSettingsPresets(
        var low: AutoDownloadSettings,
        var medium: AutoDownloadSettings,
        var high: AutoDownloadSettings
    ) : Object() {
    ...
    class DeepLinkInfo(
        var text: FormattedText,
        var needUpdateApplication: Boolean
    ) : Object() {
    ...
    class UpdateScopeNotificationSettings(
        var scope: NotificationSettingsScope,
        var notificationSettings: ScopeNotificationSettings
    ) : Update() {
    ...
    class UpdateNotificationGroup(
        ...
        var type: NotificationGroupType,
        var chatId: Long,
        var notificationSettingsChatId: Long,
        var isSilent: Boolean,
        var totalCount: Int,
        var addedNotifications: Array<Notification>,
        var removedNotificationIds: IntArray
    ) : Update() {
    ...
    class UpdateActiveNotifications(
        var groups: Array<NotificationGroup>
    ) : Update() {
    ...
    class UpdateHavePendingNotifications(
        var haveDelayedNotifications: Boolean,
        var haveUnreceivedNotifications: Boolean
    ) : Update() {
    ...
    class UpdateUnreadChatCount(
        ...
        var unreadCount: Int,
        var unreadUnmutedCount: Int,
        var markedAsUnreadCount: Int,
        var markedAsUnreadUnmutedCount: Int
    ) : Update() {
        override val constructor: Int get() = 1994494530
    }
    ...
    class RequestQrCodeAuthentication(
        var otherUserIds: IntArray = intArrayOf()
    ) : Function() {
    ...
    class SetDatabaseEncryptionKey(
        var newEncryptionKey: ByteArray = byteArrayOf()
    ) : Function() {
    ...
    class SetPassword(
        ...
        var setRecoveryEmailAddress: Boolean = false,
    ...
    class GetMessages(
        var chatId: Long = 0L,
        var messageIds: LongArray = longArrayOf()
    ) : Function() {
    ...
    class GetChats(
        ...
        var offsetOrder: Long = 0L,
        var offsetChatId: Long = 0L,
        var limit: Int = 0
    ) : Function() {
    ...
    class DeleteChatHistory(
        var chatId: Long = 0L,
        var removeFromChatList: Boolean = false,
    ...
    class SendMessageAlbum(
        ...
        var replyToMessageId: Long = 0L,
        var options: SendMessageOptions? = null,
        var inputMessageContents: Array<InputMessageContent> = emptyArray()
    ) : Function() {
    ...
    class SetPollAnswer(
        var chatId: Long = 0L,
        var messageId: Long = 0L,
        var optionIds: IntArray = intArrayOf()
    ) : Function() {
    ...
    class GetLoginUrl(
        ...
        var messageId: Long = 0L,
        var buttonId: Int = 0,
        var allowWriteAccess: Boolean = false
    ) : Function() {
    ...
    class AnswerInlineQuery(
        var inlineQueryId: Long = 0L,
        var isPersonal: Boolean = false,
        var results: Array<InputInlineQueryResult> = emptyArray(),
        var cacheTime: Int = 0,
    ...
    class AnswerShippingQuery(
        var shippingQueryId: Long = 0L,
        var shippingOptions: Array<ShippingOption> = emptyArray(),
    ...
    class AnswerPreCheckoutQuery(
        var preCheckoutQueryId: Long = 0L,
        var errorMessage: String? = null
    ) : Function() {
    ...
    class ToggleChatIsMarkedAsUnread(
        var chatId: Long = 0L,
        var isMarkedAsUnread: Boolean = false
    ) : Function() {
    ...
    class ToggleChatDefaultDisableNotification(
        var chatId: Long = 0L,
        var defaultDisableNotification: Boolean = false
    ) : Function() {
    ...
    class ClearAllDraftMessages(
        var excludeSecretChats: Boolean = false
    ) : Function() {
    ...
    class CancelDownloadFile(
        var fileId: Int = 0,
        var onlyIfPending: Boolean = false
    ) : Function() {
    ...
    class SendCallRating(
        ...
        var problems: Array<CallProblem> = emptyArray()
    ) : Function() {
    ...
    class AddContact(
        var contact: Contact? = null,
        var sharePhoneNumber: Boolean = false
    ) : Function() {
    ...
    class ImportContacts(
        var contacts: Array<Contact> = emptyArray()
    ) : Function() {
    ...
    class GetArchivedStickerSets(
        var isMasks: Boolean = false,
        var offsetStickerSetId: Long = 0L,
        var limit: Int = 0
    ) : Function() {
    ...
    class ViewTrendingStickerSets(
        var stickerSetIds: LongArray = longArrayOf()
    ) : Function() {
    ...
    class ToggleSupergroupSignMessages(
        var supergroupId: Int = 0,
        var signMessages: Boolean = false
    ) : Function() {
    ...
    class GetBackgrounds(
        var forDarkTheme: Boolean = false
    ) : Function() {
    ...
    class SetCustomLanguagePack(
        ...
        var strings: Array<LanguagePackString> = emptyArray()
    ) : Function() {
    ...
    class OptimizeStorage(
        ...
        var ttl: Int = 0,
        var count: Int = 0,
        var immunityDelay: Int = 0,
        var fileTypes: Array<FileType> = emptyArray(),
        var chatIds: LongArray = longArrayOf(),
        var excludeChatIds: LongArray = longArrayOf(),
        var chatLimit: Int = 0
    ) : Function() {
    ...
    class SetPassportElementErrors(
        var userId: Int = 0,
        var errors: Array<InputPassportElementError> = emptyArray()
    ) : Function() {
    ...
    class SendPassportAuthorizationForm(
        var autorizationFormId: Int = 0,
        var types: Array<PassportElementType> = emptyArray()
    ) : Function() {
    ...
    class CreateNewStickerSet(
        ...
        var name: String? = null,
        var isMasks: Boolean = false,
        var stickers: Array<InputSticker> = emptyArray()
    ) : Function() {
    ...
    class SendTonLiteServerRequest(
        var request: ByteArray = byteArrayOf()
    ) : Function() {
    ...
    class TestCallVectorIntObject(
        var x: Array<TestInt> = emptyArray()
    ) : Function() {
    ...
    class TestCallVectorStringObject(
        var x: Array<TestString> = emptyArray()
    ) : Function() {
